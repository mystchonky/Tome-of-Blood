package com.luiq54.ArsCruor.client.gui;
...
import com.luiq54.ArsCruor.common.capability.IEssenceCap;
...
//        int yOffset = minecraft.getWindow().getGuiScaledHeight() - 5 + Config.MANABAR_Y_OFFSET.get();
        ...
        RenderSystem.setShaderTexture(0, new ResourceLocation(ArsCruor.MODID, "textures/gui/manabar_gui_border.png"));
        blit(ms, offsetLeft, yOffset - 18, 0, 0, 108, 18, 256, 256);
        int manaOffset = (int) (((ClientInfo.ticksInGame + pt) / 3 % (33))) * 6;

        // 96
        RenderSystem.setShaderTexture(0, new ResourceLocation(ArsCruor.MODID, "textures/gui/manabar_gui_mana.png"));
